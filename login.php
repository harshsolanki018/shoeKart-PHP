...
<main class="mx-auto flex min-h-[calc(100vh-5rem)] max-w-2xl items-center px-4 py-10 sm:px-6 lg:px-8">
    <section class="w-full rounded-[32px] border border-slate-200 bg-white p-8 shadow-[0_24px_60px_rgba(15,23,42,0.08)] sm:p-10">
